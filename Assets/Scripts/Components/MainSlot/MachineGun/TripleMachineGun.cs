...
public class TripleMachineGun : MachineGunBase
{
    private MachineGunBase _gun;

    public TripleMachineGun(MachineGunBase gun)
    {
        _gun = gun;
        Debug.Log($"트리플 머신건, 머신건: {_gun.GetType().Name}");
    }
    ...
    public override int TargetsPerShot => _gun.TargetsPerShot * 3;
