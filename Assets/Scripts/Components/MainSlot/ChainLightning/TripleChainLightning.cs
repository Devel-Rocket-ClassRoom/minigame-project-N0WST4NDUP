public class TripleChainLightning : ChainLightningBase
{
    private ChainLightningBase _inner;

    public TripleChainLightning(ChainLightningBase inner) => _inner = inner;

    public override int Level => _inner.Level;
    public override bool CanUpgrade => _inner.CanUpgrade;
    public override int StrandCount => _inner.StrandCount * 3;       // 가닥 ×3
